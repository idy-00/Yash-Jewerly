    ...
    <>
      ...
      <section className="relative min-h-[58vh] bg-noir flex items-end pb-16 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-8 md:px-14 relative z-10 pt-28">
          ...
          {/* Titre en un seul bloc — pas de traitement lettrine */}
          <motion.h1
            className="font-playfair font-bold text-blanc leading-[1.05]"
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-16 items-start">
          ...
          >
            <div className="relative overflow-hidden" style={{ aspectRatio: '3/4' }}>
              <img
                src="/WhatsApp%20Image%202026-07-08%20at%204.02.47%20PM.jpeg"
                alt="Sautoir Yash — Every Detail Matters"
                className="w-full h-full object-cover"
                style={{ objectPosition: '10% 4%' }}
              />
            ...
            <div className="mt-5">
              ...
              <p className="font-cormorant italic text-ink/50 text-[14.5px] leading-[1.88]">
                "Every Detail Matters.<br />Timeless Elegance."
              </p>
              <p className="font-jost font-light text-[7.5px] tracking-[0.26em] uppercase text-gold-deep mt-2.5">
          ...
          <div className="md:col-span-7 md:pt-6">
            ...
            >
              <p className="font-jost font-light text-[8px] tracking-[0.32em] uppercase text-gold-deep mb-4">
                01 — Notre Histoire
              </p>
              {/* Placeholder élégant — pas de bordure pointillée wireframe */}
              <p className="font-cormorant italic text-ink/35 text-[15px] leading-[1.9]">
            ...
            >
              ...
              <p className="font-playfair font-semibold text-ink text-[18px] leading-[1.4] mb-4">
                Devenir la référence africaine de la joaillerie premium, puis rayonner à l'international.
              </p>
              <p className="font-jost font-light text-[12.5px] leading-[1.9] text-ink/52">
            ...
            <div className="h-px bg-gold/12 mb-9" />
            ...
            >
              {CHIFFRES.map(({ val, label }) => (
                <div key={label} className="text-center">
                  <p className="font-playfair font-bold text-gold-deep" style={{ fontSize: 'clamp(20px, 2.6vw, 32px)' }}>
                    {val}
                  </p>
                  <p className="font-jost font-light text-[7px] tracking-[0.22em] uppercase text-ink/35 mt-1">
                    {label}
                  </p>
                </div>
              ))}
      ...
      {/* Pourquoi Yash — couleurs uniformes text-ink/48 */}
      <section className="bg-cream-2 py-24 px-8 md:px-14">
        <div className="max-w-6xl mx-auto">
          ...
          <motion.h2
            className="font-playfair font-bold text-ink leading-[1.08] mb-5"
            ...
            {POURQUOI.map((item, i) => (
              ...
              >
                <div className="flex items-center gap-2 mb-2">
                  <span className="text-gold-deep text-[9px]">✓</span>
                  <p className="font-jost font-light text-[8px] tracking-[0.22em] uppercase text-gold-deep">
                    {item.label}
                  </p>
                </div>
                {/* Style inline pour éviter toute couleur héritée de lien */}
                <p className="font-jost font-light text-[11.5px] leading-[1.75] pl-4"
                  style={{ color: 'rgba(26,22,16,0.50)' }}>
                  {item.desc}
                </p>
              </motion.div>
            ))}
      ...
      <section className="bg-noir py-24 px-8 md:px-14">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          >
            <img
              src="/WhatsApp%20Image%202026-07-08%20at%203.58.28%20PM.jpeg"
              alt="Chapelet Musulman — Savoir-faire Yash Jewelry"
              className="w-full h-full object-cover"
          ...
          >
            <p className="font-jost font-light text-[9px] tracking-[0.36em] uppercase text-gold mb-5">
              10 — Savoir-Faire
            </p>
            <h2 className="font-playfair font-bold text-blanc leading-[1.08] mb-5"
              style={{ fontSize: 'clamp(24px, 3vw, 40px)' }}
            >
              Le détail fait la pièce.
            </h2>
            <Divider light className="justify-start mb-8" />
            <p className="font-jost font-light text-[12.5px] leading-[1.9] mb-9"
              style={{ color: 'rgba(247,242,231,0.46)' }}>
            ...
            <ul className="space-y-3.5">
              {SAVOIRFAIRE.map((item, i) => (
                ...
                >
                  ...
                  <span className="font-jost font-light text-[11px] tracking-[0.16em] uppercase"
